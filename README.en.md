...
```powershell
codex plugin marketplace add bennyzbyen/pipeline-forge --ref v2.0.1
```
...
PipelineForge follows [Semantic Versioning](VERSIONING.md). The current stable version is `2.0.1`; see [CHANGELOG.md](CHANGELOG.md) for release notes.
